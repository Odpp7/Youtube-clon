    ...
    <header className="flex items-center justify-between px-4 py-2 bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-1">
          <img src="/YoutubeStudio.png" width="120" className="cursor-pointer"/>
        </div>
      </div>
      ...
      <div className="flex gap-5 items-center">
        <button onClick={onUploadClick} className="px-3 py-1 border border-gray-300 rounded-full hover:bg-gray-200 cursor-pointer flex gap-2 font-[600]">
          <Video /> Crear
        </button>
            ...
            <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
              ...
              <div className="p-2">
                ...
                <div className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded cursor-pointer">
                  ...
                  <span className="text-gray-700">Subir Video</span>
                </div>
                
                <div onClick={goToYoutube} className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded cursor-pointer">
                  <div className="w-6 h-6 flex items-center justify-center">
                    <svg className="w-5 h-5"> <LogOut/> </svg>
                  </div>
                  <span>Volver a Youtube</span>
                </div>
              </div>
            </div>
          )}
