...
export const SideBarStudio = ({ isOpen }) => {
  ...
  return (
    <aside className={`fixed left-0 top-16 h-full transition-all duration-300 z-40 bg-white border-r border-gray-200 ${isOpen ? 'w-60' : 'w-16'} overflow-y-auto`}>
      <div className="py-4">
        ...
        {/* Si la sidebar está cerrada, mostrar solo el avatar */}
        {user && !isOpen && (
